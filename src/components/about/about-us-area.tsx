...
export default function AboutUsArea() {
  const { services, story } = aboutPageContent;
              ...
              <div className="col-xl-7 col-lg-7 col-md-8">
                ...
                <div className="row">
                  <div className="col-12">
                    <Link
                      className="tp-btn-white-sm border-style"
